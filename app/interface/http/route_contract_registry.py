...
ROUTE_CONTRACTS: dict[str, RouteContract] = {
    ...
    "pac_delete_action_plan": RouteContract("quality_action_plan", "scalar"),
    ...
    "pac_list_export_templates": RouteContract("quality_action_plan_export_template", "paged_list"),
    ...
    "pac_update_plan_evidence": RouteContract("quality_action_plan_evidence", "scalar"),
